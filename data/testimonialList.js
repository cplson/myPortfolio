const testimonialList = {
  ia: {
    ...
    name: "Ia Vue",
    testimonial:
      "I met James through a software engineering program at Prime Digital Academy. Throughout the program, James consistently demonstrated a remarkable aptitude for problem-solving, a strong work ethic, and a true passion for coding. Their ability to quickly grasp complex concepts and implement them in practical projects was truly impressive. I had the pleasure of working closely with James on a client project during a two-week sprint, where we were tasked with creating a mobile-first app for a client, Honey Does LLC. James exhibited exceptional teamwork and leadership skills, fostering a collaborative environment that allowed us to successfully deliver a high-quality product within the tight deadline. Their ability to communicate effectively, delegate tasks, and keep the team motivated was instrumental in our project's success. Beyond their technical prowess, James' dedication to understanding the client's needs and adapting our solution accordingly was truly commendable. Their contributions went beyond coding, as they took the initiative to ensure that the app aligned seamlessly with the client's vision. I have no doubt that James will excel and contribute significantly to any software engineering team fortunate enough to have them on board. Their combination of technical expertise, leadership abilities, and collaborative nature make them a valuable asset to any organization.",
